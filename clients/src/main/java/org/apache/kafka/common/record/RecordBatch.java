 ...
 * In old versions of the record format (versions 0 and 1), a batch consisted always of a single record if no compression was enabled,
 * but could contain many records otherwise.

...
/**
 * This class is used to send requests to the brokers to propagate() the migration(迁移) state.
 *
 ...
 * @param stateChangeLogger logger to log the various events while sending requests and receiving responses from the brokers
 *
 */

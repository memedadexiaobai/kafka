...
/**
  ...
  * <ul>
  *   <li>Per-broker configs persisted at <tt>/configs/brokers/{brokerId}</tt>: These can be described/altered(改变)
  ...
  * </ul>
  * The order of precedence(优先级) for broker configs is:
  * <ol>
